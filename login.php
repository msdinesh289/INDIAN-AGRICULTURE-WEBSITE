...
<!-- Mirrored from tunatheme.com/tf/html/broccoli-preview/broccoli/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 May 2022 20:03:24 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="account-login-inner">
                        <form method="post"  action="login.php" class="ltn__form-box contact-form-box">
                ...
                <div class="col-lg-6">
                    <div class="account-create text-center pt-50">
                        ...
                        <div class="btn-wrapper">
                            <a href="index.html" class="theme-btn-1 btn black-btn">CREATE ACCOUNT</a>
                        </div>
                    </div>
                </div>
            </div>
